...
function ShellRouter({ children }: { children: React.ReactNode }) {
  ...
  // The landing page is fully self-contained: it renders its own navbar and
  // footer and is intentionally decoupled from the shared marketing shell.
  if (pathname === '/') {
    return <>{children}</>
  }
  ...
  // Other public pages still use the shared marketing website chrome.
